    ...
    return (
        <motion.section id="about" className="py-20 px-6 bg-stone-500 dark:bg-gray-900 text-white pt-24 dark:text-black"
            ...
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-6 dark:text-neutral-400">About Me</h2>
                <p className="text-lg text-gray-300 dark:text-slate-400">I'm a passionate developer who loves building responsive web and Android apps.
